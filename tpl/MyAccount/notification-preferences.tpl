				...
				<div class="row gy-3">
					<div class="notification-row col-12 col-sm-6">
						...
						<div class="form-check form-switch">
							<input class="form-check-input" type="checkbox" role="switch" id="{ReservationEvent::Created}"
								name="{ReservationEvent::Created}" {if $Created}checked="checked" {/if}>
					...
					<div class="notification-row col-12 col-sm-6">
						...
						<div class="form-check form-switch">
							<input class="form-check-input" type="checkbox" role="switch" id="{ReservationEvent::Updated}"
								name="{ReservationEvent::Updated}" {if $Updated}checked="checked" {/if}>
							<label class="form-check-label"
					...
					<div class="notification-row col-12 col-sm-6">
						...
						<div class="form-check form-switch">
							<input class="form-check-input" type="checkbox" role="switch" id="{ReservationEvent::Deleted}"
								name="{ReservationEvent::Deleted}" {if $Deleted}checked="checked" {/if}>
							<label class="form-check-label"
					...
					<div class="notification-row alt col-12 col-sm-6">
						...
						<div class="form-check form-switch">
							<input class="form-check-input" type="checkbox" role="switch" id="{ReservationEvent::Approved}"
								name="{ReservationEvent::Approved}" {if $Approved}checked="checked" {/if}>
							<label class="form-check-label"
					...
					<div class="notification-row col-12 col-sm-6">
						...
						<div class="form-check form-switch">
							<input class="form-check-input" type="checkbox" role="switch"
								...
								name="{ReservationEvent::ParticipationChanged}" {if $ParticipantChanged}checked="checked"
								{/if}>
							<label class="form-check-label"
