<div class="startNoticeAdd" data-value="{$resource->GetMinNoticeAdd()}"
	data-days="{$resource->GetMinNoticeAdd()->Days()}" data-hours="{$resource->GetMinNoticeAdd()->Hours()}"
...
<div class="startNoticeUpdate" data-value="{$resource->GetMinNoticeUpdate()}"
	data-days="{$resource->GetMinNoticeUpdate()->Days()}" data-hours="{$resource->GetMinNoticeUpdate()->Hours()}"
...
<div class="startNoticeDelete" data-value="{$resource->GetMinNoticeDelete()}"
	data-days="{$resource->GetMinNoticeDelete()->Days()}" data-hours="{$resource->GetMinNoticeDelete()->Hours()}"
...
<div class="endNotice" data-value="{$resource->GetMaxNotice()}" data-days="{$resource->GetMaxNotice()->Days()}"
	data-hours="{$resource->GetMaxNotice()->Hours()}" data-minutes="{$resource->GetMaxNotice()->Minutes()}">
...
<div class="requiresApproval" data-value="{$resource->GetRequiresApproval()}">
...
<div class="autoAssign" data-value="{$resource->GetAutoAssign()}">
...
<div class="enableCheckin" data-value="{$resource->IsCheckInEnabled()}">
...
<div class="autoRelease" data-value="{$resource->GetAutoReleaseMinutes()}">
	{if $resource->IsAutoReleased()}
		{translate key=AutoReleaseNotification args=$resource->GetAutoReleaseMinutes()}
	{/if}
</div>
<div class="allowConcurrent" data-allow-concurrent="{$resource->GetAllowConcurrentReservations()}"
