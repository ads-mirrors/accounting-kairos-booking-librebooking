	...
	<ul class="list-group mb-2">
		...
		<li class="list-group-item">
			...
			<div class="d-flex align-items-center justify-content-center my-2">
				<a href="{$ScriptUrl}/img/{$LogoUrl}" download="{$ScriptUrl}/img/{$LogoUrl}" class="link-primary"><i
		...
		<li class="list-group-item">
			...
			<div class="d-flex align-items-center justify-content-center my-2">
				<a href="{$ScriptUrl}/{$FaviconUrl}" download="{$ScriptUrl}/img/{$FaviconUrl}" class="link-primary"><i
		...
		<li class="list-group-item">
			<div>
				...
				<div class="d-flex align-items-center justify-content-center my-2">
					<a href="{$ScriptUrl}/css/{$CssUrl}" download="{$ScriptUrl}/css/{$CssUrl}" class="link-primary"><i
							class="bi bi-download me-1"></i>{$CssUrl}</a>
					<div class="vr mx-1"></div>
