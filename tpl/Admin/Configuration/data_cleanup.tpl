...
<div class="mb-3 p-3 border rounded bg-light">
	...
	<div class="input-group input-group-sm">
		<label class="input-group-text fw-bold" for="blackoutDeleteDate">{translate key=DeleteBlackoutsBefore}</label>
...
<div class="mb-3 p-3 border rounded bg-light">
	...
	<div class="input-group input-group-sm">
		<label class="input-group-text fw-bold" for="userDeleteDate">{translate key=PermanentlyDeleteUsers}</label>
